...
for k_knn in [3, 5, 7, 9]:
    ...
    for i, (train_index, test_index) in enumerate(loo.split(validation_images)):
        ...
        if (knncalc(k_knn, entropy1_distances) == 'genuine' and test_entropy1[0] == 'genuine') or (
                knncalc(k_knn, entropy1_distances) == 'synthethic' and test_entropy1[
            0] == 'spoofed'): correct_entropy1_preds += 1

        if (knncalc(k_knn, entropy10x10_distances) == 'genuine' and test_entropy10x10[0] == 'genuine') or (
                knncalc(k_knn, entropy10x10_distances) == 'synthethic' and test_entropy10x10[
            0] == 'spoofed'): correct_entropy10x10_preds += 1
        if knncalc(k_knn, entropy20x20_distances) == 'genuine' and test_entropy20x20[0] == 'genuine' or knncalc(k_knn,
                                                                                                                entropy20x20_distances) == 'synthethic' and \
                test_entropy20x20[0] == 'spoofed': correct_entropy20x20_preds += 1
        if knncalc(k_knn, entropy30x30_distances) == 'genuine' and test_entropy30x30[0] == 'genuine' or knncalc(k_knn,
                                                                                                                entropy30x30_distances) == 'synthethic' and \
                test_entropy30x30[0] == 'spoofed': correct_entropy30x30_preds += 1
        if knncalc(k_knn, entropy40x40_distances) == 'genuine' and test_entropy40x40[0] == 'genuine' or knncalc(k_knn,
                                                                                                                entropy40x40_distances) == 'synthethic' and \
                test_entropy40x40[0] == 'spoofed': correct_entropy40x40_preds += 1
        if knncalc(k_knn, entropy50x50_distances) == 'genuine' and test_entropy50x50[0] == 'genuine' or knncalc(k_knn,
                                                                                                                entropy50x50_distances) == 'synthethic' and \
                test_entropy50x50[0] == 'spoofed': correct_entropy50x50_preds += 1
        if knncalc(k_knn, entropy70x70_distances) == 'genuine' and test_entropy70x70[0] == 'genuine' or knncalc(k_knn,
                                                                                                                entropy70x70_distances) == 'synthethic' and \
                test_entropy70x70[0] == 'spoofed': correct_entropy70x70_preds += 1
        if knncalc(k_knn, entropy100x100_distances) == 'genuine' and test_entropy100x100[0] == 'genuine' or knncalc(
            k_knn, entropy100x100_distances) == 'synthethic' and test_entropy100x100[
            0] == 'spoofed': correct_entropy100x100_preds += 1
        if knncalc(k_knn, entropy100x200_distances) == 'genuine' and test_entropy100x200[0] == 'genuine' or knncalc(
            k_knn, entropy100x200_distances) == 'synthethic' and test_entropy100x200[
            0] == 'spoofed': correct_entropy100x200_preds += 1
...
for k_knn in [3, 5, 7, 9]:
    ...
    for i, (train_index, test_index) in enumerate(loo.split(validation_images)):
        ...
        if (knncalc(k_knn, entropy10_distances) == 'genuine' and test_entropy10[0] == 'genuine') or (
                knncalc(k_knn, entropy10_distances) == 'synthethic' and test_entropy10[
            0] == 'spoofed'): correct_entropy10_preds += 1
        if (knncalc(k_knn, entropy20_distances) == 'genuine' and test_entropy20[0] == 'genuine') or (
                knncalc(k_knn, entropy20_distances) == 'synthethic' and test_entropy20[
            0] == 'spoofed'): correct_entropy20_preds += 1
        if (knncalc(k_knn, entropy30_distances) == 'genuine' and test_entropy30[0] == 'genuine') or (
                knncalc(k_knn, entropy30_distances) == 'synthethic' and test_entropy30[
            0] == 'spoofed'): correct_entropy30_preds += 1
        if (knncalc(k_knn, entropy40_distances) == 'genuine' and test_entropy40[0] == 'genuine') or (
                knncalc(k_knn, entropy40_distances) == 'synthethic' and test_entropy40[
            0] == 'spoofed'): correct_entropy40_preds += 1
        if (knncalc(k_knn, entropy50_distances) == 'genuine' and test_entropy50[0] == 'genuine') or (
                knncalc(k_knn, entropy50_distances) == 'synthethic' and test_entropy50[
            0] == 'spoofed'): correct_entropy50_preds += 1
        if (knncalc(k_knn, entropy100_distances) == 'genuine' and test_entropy100[0] == 'genuine') or (
                knncalc(k_knn, entropy100_distances) == 'synthethic' and test_entropy100[
            0] == 'spoofed'): correct_entropy100_preds += 1
