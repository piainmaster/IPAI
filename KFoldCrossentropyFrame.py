...
def main():
    ...
    num_frames = 6  # Adjust the number of frames as needed
    ...
    spoof_labels = np.ones(len(spoof_images))  # Spoof class label
    original_labels = np.zeros(len(original_images))  # Original class label
